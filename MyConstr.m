classdef MyConstr
    ...
    methods
        ...
        function A = get.A(obj)
            Acols = obj.nBeams * 2 * 3;
            idx1 = 6 * (obj.beam1idx - 1) + 3 * (obj.node1idx - 1) + 1;
            idx2 = 6 * (obj.beam2idx - 1) + 3 * (obj.node2idx - 1) + 1;
